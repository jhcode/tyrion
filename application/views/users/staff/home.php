<div class="base-container scroll-area">
	<div class="slider">
		...
		<div class="widget-column">
			<div class="widget student-list">
				<div class="title row">
					<div class="col-md-8"><span class="fa fa-users"></span> Student List
                    </div>                                    
					<div class="col-md-4 small-add-btn"></div>
				</div>
				<!-- Student Row -->
				<section>
					<div><?= img(base_url('assets/imgs/avatar.png')); ?></div>
					<div><h4><a href="">Rajesh Prateski</a></h4></div>
					<div>
						<h2>20<sup>%</sup></h2>
						<p>Average Score</p>
					</div>
