                  ...
                  <div class="widget">
                        <div class="darkblue">
                              ...
                              <div class="title row">
                                    ...
                                    <div class="col-md-4 boxorangeright">
                                          <? $owner_member = "<a data-reveal-id='memberEdit'>Invite <i class='glyphicon glyphicon-edit'></i></a>";
                        ...
                        <div class="widget addpostass boxlightrange">
                                    ...
                                    <div class="addhthree boxlightrange">                                                                     
                                          ...
                                          <div class="acenter addhfive">
                                                ...
                                                <textarea rows="3" class="text-box instant-text" name="chat" placeholder="Type your comment here..."></textarea>
                                                <?= form_close(); ?>
                                          </div>
                                    </div> 
                              </div>
                                                ...
                                                <div class="row">
                                                      <div class="col-md-8 column">
                                                            ...
                                                            <div class="clearfix">
                                                                  ...
                                                                  <div class="col-md-8">
                                                                        <h4><input type="radio" name="upload_option"> Upload Video</h4>
                                                                        <input type="file" name="file">

                                                                        <h4><input type="radio" name="upload_option"> Youtube Link</h4>
                                          ...
                                          <div class="content-scroller" id="quiz">
                                                <div class="row">
                                                      ...
                                                      <div class="col-md-4">
                                                            ...
                                                            <input type="number" disabled placeholder="HRS"><input disabled placeholder="MINS" type="number">
                                                      </div>
                                                </div>
                                                <div class="sec-row">
                                                ...
                                                <ol class="quizlist">
                                                      <li class="clearfix">
                                                            <div class="col-md-10"><input type="text" name="" placeholder="Enter Question"></div>
                                                            <div class="col-md-2">
